...
import beijinMap from "./map/world.json"
...
const initChart=()=>{
  state.chartData.alladcode=beijinMap;
  state.chartData.geoJson=beijinMap;
  state.chartData.geoJson.code=0
  state.chartData.geoJson.name="beijinMap"
  echarts.registerMap("beijinMap", beijinMap);
...
const getMapData=()=>{
  let mapData = [],pointData=[] ,pinData = [], circleData = [],warningData = [],dangerData = [], sum = 0,
      topIndex=[12,8,6,7,11,14],warnIndex=[13,5],dangerIndex=[15];
