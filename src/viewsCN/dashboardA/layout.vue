...
<template>
  <div class="screen1080A">
    ...
    <systemTitleA2 :config="systemTitleConfig">Unimax hospital Admin</systemTitleA2>
    <echartMap></echartMap>
  </div>
</template>
<style lang="less">
.screen1080A{ z-index: 1;padding:60px 30px 30px 30px; height: 100%; //url(../common/images/bg.png) 
